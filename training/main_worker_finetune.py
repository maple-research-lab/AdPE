...
import optimizer.lr_decay as lrd
...
def main_worker(gpu, ngpus_per_node,args):
    ...
    if args.pe_type==0:
        import model.ape_models_vit as models_vit
    elif args.pe_type==1:
        import model.rpe_models_vit as models_vit
    elif args.pe_type==2:
        import model.rpe_interpolate_models_vit as models_vit
    else:
        print("only supporting 0,1,2 for --pe_type")
        sys.exit(1)
    ...
    if args.finetune and not args.eval:
        ...
        from position_embed.ape_pos_embed import interpolate_pos_embed
